    ...
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400'>
          ...
          onSubmit={onSubmitEmail}
            className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
              <h1 className='text-3xl font-semibold text-white text-center mb-4'>Reset Password</h1>
              <p className='text-center text-indigo-300 mb-6'>Enter your registered email address</p>
              <div className='flex items-center mb-4 gap-3 w-full px-5 py-2.5 rounded-full bg-gray-700'>
          ...
          onSubmit={onSubmitOtp}
            className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
              <h1 className='text-3xl font-semibold text-white text-center mb-4'>Reset Password OTP</h1>
              <p className='text-center text-indigo-300 mb-6'>Enter the 6-digit code sent to your email id</p>
              <div className='flex mt-10 mb-10 justify-between' onPaste={handlePaste}>
                {
      ...
      onSubmit={onSubmitNewPassword}
          className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
            <h1 className='text-3xl font-semibold text-white text-center mb-4'>New Password</h1>
            <p className='text-center text-indigo-300 mb-6'>Enter the new password</p>
            <div className='flex items-center mb-4 gap-3 w-full px-5 py-2.5 rounded-full bg-gray-700'>
            ...
            <button type = 'submit' className='w-full py-3 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full'>Reset Password</button>
